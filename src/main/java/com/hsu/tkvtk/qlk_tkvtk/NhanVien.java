...
public class NhanVien {
    ...
    public NhanVien(int mSnv, String tenNv, String chucVu, int namSinh,String gioiTinh,String sDt, String addr, String tenNH,String sTk,int soNgayCong,float mucLuong,float tongLuong){
       this.mSnv=mSnv;
       this.tenNv=tenNv;
       this.chucVu=chucVu;
       this.namSinh=namSinh;
